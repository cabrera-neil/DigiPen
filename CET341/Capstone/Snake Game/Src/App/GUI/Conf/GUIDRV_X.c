 ...
 *       Draw Bitmap 1 BPP
 */
static void _DrawBitLine1BPP( GUI_DEVICE* pDevice,
                              int x,
                              int y,
 ...
 *       Draw Bitmap 2 BPP
 */
static void _DrawBitLine2BPP( GUI_DEVICE* pDevice,
                              int x,
                              int y,
                              U8 const GUI_UNI_PTR* p,
                              int Diff,
 ...
 *       Draw Bitmap 4 BPP
 */
static void _DrawBitLine4BPP( GUI_DEVICE* pDevice,
                              int x,
                              int y,
                              U8 const GUI_UNI_PTR* p,
                              int Diff,
 ...
 *       Draw Bitmap 8 BPP
 */
static void _DrawBitLine8BPP( GUI_DEVICE* pDevice,
                              int x,
                              int y,
                              U8 const GUI_UNI_PTR* p,
                              int xsize,
 ...
 */
static void _DrawBitLine16BPP(
GUI_DEVICE* pDevice, int x, int y, U16 const GUI_UNI_PTR* p, int xsize )
{


    LCD_SetArea( x, x + xsize, y, y + 1 );
    LCD_WriteDataPixel( p, xsize << 1 );
}
#endif
 ...
 *       _DrawBitmap
 */
static void _DrawBitmap( GUI_DEVICE* pDevice,
                         int x0,
                         int y0,
                         int xSize,
                         int ySize,
                         ...
                         const LCD_PIXELINDEX* pTrans )
{
    ...
    switch( BitsPerPixel )
    {
        ...
        case 16:
            ...
            LCD_WriteDataPixel( (void*)pData, xSize*ySize );
            break;
        //
