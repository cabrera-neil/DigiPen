...
typedef	int 	UART_SET_CFG( void const *pHandle, UART_CFG Databit, UART_CFG Parity, UART_CFG Stopbit );
...
/******************************************************************************
 ...
 @revision	: 1.0.0
******************************************************************************/
int SerialInit( PUART_HANDLE pHandle, UART_DRIVER const *pDriver, uint8_t nPort, uint32_t nBaud );


void SerialBuffer( PUART_HANDLE	pHandle, char *pTxBuf, uint32_t nTxSize, char *pRxBuf, uint32_t nRxSize );
...
******************************************************************************/
void SerialAddCallback( PUART_HANDLE	pHandle, UART_CB_ONTX *pfOnTx, UART_CB_ONRX *pfOnRx );
...
******************************************************************************/
int SerialConfig( UART_HANDLE const *pHandle, UART_CFG Databit, UART_CFG Parity, UART_CFG Stopbit );
...
int SerialWriteEx( PUART_HANDLE pHandle, void const *pData, int nSize );
